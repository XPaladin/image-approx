...
**
** Created: Fri 12. Jun 18:24:18 2009
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QObject::connect(actionMalla, SIGNAL(activated()), MainWindow, SLOT(repaint()));
        QObject::connect(actionAproximacion, SIGNAL(activated()), centralWidget, SLOT(repaint()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionAplicar_Algoritmo->setText(QApplication::translate("MainWindow", "Crear Malla ..", 0, QApplication::UnicodeUTF8));
        ...
        menuEdicion->setTitle(QApplication::translate("MainWindow", "Malla", 0, QApplication::UnicodeUTF8));
